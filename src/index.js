...
function layout(title, content, session = null) {
  return `<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)} · TOTP 看板</title><style>${CSS}${DESIGN_CSS}${REFERENCE_CSS}${LIGHT_CSS}${SYSTEM_DARK_CSS}</style></head><body>
